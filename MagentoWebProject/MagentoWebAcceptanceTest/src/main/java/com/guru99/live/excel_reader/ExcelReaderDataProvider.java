package com.guru99.live.excel_reader;
...
public class ExcelReaderDataProvider {
	...
	public ExcelReaderDataProvider(String path) {
		this.path = path;
		try {
	...
	public static void main(String arg[]) throws IOException {
		ExcelReaderDataProvider datatable = null;
		datatable = new ExcelReaderDataProvider(
